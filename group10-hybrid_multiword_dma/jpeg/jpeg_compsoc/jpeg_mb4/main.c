...
PBlock pbout[10];
FBlock fbout;
volatile ColorBuffer *cbout = (ColorBuffer *)(mb4_dmamem0_BASEADDR + CBOUT_STRUCT_OFFSET);
unsigned int *done_flag = (unsigned int *)(mb4_dmamem0_BASEADDR + DONE_FLAG_VALUE_OFFSET);
volatile unsigned int *stop = (unsigned int *)(mb4_cmem0_BASEADDR + STOP_FLAG_OFFSET);
volatile unsigned int *done = (unsigned int *)(mb1_cmem0_pt_REMOTEADDR + DONE4_FLAG_OFFSET);
