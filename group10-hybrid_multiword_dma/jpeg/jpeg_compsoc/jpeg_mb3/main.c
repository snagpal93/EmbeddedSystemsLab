...
PBlock pbout[10];
FBlock fbout;
volatile ColorBuffer *cbout = (ColorBuffer *)(mb3_dmamem0_BASEADDR + CBOUT_STRUCT_OFFSET);
unsigned int *done_flag = (unsigned int *)(mb3_dmamem0_BASEADDR + DONE_FLAG_VALUE_OFFSET);
